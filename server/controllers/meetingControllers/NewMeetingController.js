const NewMeeting = require("../../models/meetingModels/NewMeetingModel");
...
const createMeeting = async (req, res) => {
  const { purpose, location, date, startTime, endTime, attendees, chairedBy } =
    req.body;
  ...
  try {
    ...
    const chairperson = await User.findById(chairedBy).select("name");
...
const deleteMeeting = async (req, res) => {
  try {
    ...
    const chairperson = await User.findById(meeting.chairedBy).select("name");
