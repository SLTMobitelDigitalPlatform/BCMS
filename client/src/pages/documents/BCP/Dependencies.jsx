    ...
    <div className="p-6 bg-blue-50 rounded-lg shadow-md">
      ...
      <div className="flex space-x-4 border-b-2 mb-6">
        <button
          className={`px-6 py-3 rounded-t-md ${
            activeTab === 'external' ? 'border-b-2 border-green-500 text-green-700 bg-white' : 'text-gray-500'
          }`}
        ...
        <button
          className={`px-6 py-3 rounded-t-md ${
            activeTab === 'internal' ? 'border-b-2 border-green-500 text-green-700 bg-white' : 'text-gray-500'
          }`}
      ...
      <div className="p-6 bg-white rounded-md">
        ...
        <div className="flex items-center justify-between mb-4">
          <span className="font-semibold">Select Critical Business Function</span>
          <button className="text-xl">&#9660;</button>
        </div>

        <div className="flex space-x-4 mb-4">
          <button className="px-6 py-3 bg-blue-200 text-blue-700 rounded-full shadow-md">Upstream</button>
          <button className="px-6 py-3 border border-gray-300 text-gray-700 rounded-full shadow-md">Downstream</button>
        </div>
        <div className="flex justify-end">
          <button className="mt-1 px-6 py-3 bg-gradient-to-r from-[#003E81] to-[#52B14A] text-white rounded-full shadow-md">Add Details</button>
        </div>
<br></br>
