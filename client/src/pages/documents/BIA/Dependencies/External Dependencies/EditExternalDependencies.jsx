...
const EditExternalDependencies = () => {
  ...
  useEffect(() => {
    fetchExternalDependencyByIds(biaid, id);
  }, [biaid]);

  const { loading: loadingCBF, sortedCBFunctions, fetchCriticalBusinessFunctionsByBIAID } =
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await updateAlert(
        "Confirm Update",
        `Are you sure you want to update "${externalDependency.organization}"?`,
        "Yes, Update it!",
        `"${externalDependency.organization}" has been updated successfully!`,
        `Failed to update "${externalDependency.organization}"!`,
        () => updateExternalDependency(id,externalDependencyData)
      );
  ...
  if (!externalDependency || loadingCBF) {
    return (
