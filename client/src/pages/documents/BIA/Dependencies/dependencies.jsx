    ...
    <div className="bia-container w-full h-full bg-sky-100 flex flex-col rounded-2xl ">
      <div className="p-5 h-full bg-sky-100 rounded-2xl mt-5">
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-bold text-blue-900">Dependencies</h1>
          ...
          <table className="relative w-full h-full bg-cyan-50">
            <thead className="sticky top-0 bg-white">
              <tr>
                ...
                <th className="border-2 border-black">Dependency</th>
                <th className="border-2 border-black">Primary Contact</th>
                <th className="border-2 border-black">Secondary Contact</th>
                <th className="border-2 border-black">Justification</th>
              </tr>
            </thead>
            <tbody>
