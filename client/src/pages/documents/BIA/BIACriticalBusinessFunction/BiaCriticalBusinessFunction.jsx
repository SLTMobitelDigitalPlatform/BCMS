...
const BiaCriticalBusinessFunction = () => {
    ...
    <div className="bia-container w-full h-full bg-sky-100 flex flex-col rounded-2xl ">
      <div className="p-5 h-full bg-sky-100 rounded-2xl mt-5">
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-bold text-blue-900">Critical Business Function</h1>
          <Link to="/createVersion">
            <button className="btn-primary">Create Critical Business Function</button>
          </Link>
        </div>
        ...
        <div className="mt-5 h-full overflow-auto">
          <table className="relative w-full h-full bg-cyan-50">
            <thead className="sticky top-0 bg-white">
              <tr>
                <th className="border-2 border-black">Critical Business Function</th>
                <th className="border-2 border-black">Description</th>
                <th className="border-2 border-black">Critically</th>
                <th className="border-2 border-black">RTO</th>
                <th className="border-2 border-black">PRO</th>
                <th className="border-2 border-black">MTPD</th>
...
export default BiaCriticalBusinessFunction ;
