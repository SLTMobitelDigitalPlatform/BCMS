              ...
              <tbody>
                <tr>
                  ...
                  <td className="border p-2">
                    Some inconveniences caused but without any short or long
                ...
                <tr>
                  ...
                  <td className="border p-2">
                    No impacts or impact is negligible
                  </td>
                </tr>
                <tr>
                  <td className="border p-2 bg-orange-200">Moderate</td>
                  <td className="border p-2">
                    Inconveniences caused: short term negative consequences but
                ...
                <tr>
                  ...
                  <td className="border p-2">
                    Serious long term damage likely; will become catastrophic if
                    impact is not contained
                  </td>
                </tr>
                <tr>
