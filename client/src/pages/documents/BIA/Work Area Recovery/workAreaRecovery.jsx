    ...
    <div className="bia-container w-full h-full bg-sky-100 flex flex-col rounded-2xl ">
      <div className="p-5 h-full bg-sky-100 rounded-2xl mt-5">
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-bold text-blue-900">Work Area Recovery</h1>
        ...
        <div className="mt-5 h-full overflow-auto">
          <table className="relative w-full h-full bg-cyan-50">
            <thead className="sticky top-0 bg-white">
              <tr>
                <th className="border-2 border-black">Site</th>
                <th className="border-2 border-black">Available From</th>
                <th className="border-2 border-black">Available To</th>
                <th className="border-2 border-black">Travel Distance</th>
                <th className="border-2 border-black">Travel Time</th>
