...
const UpdateMeeting = () => {
  ...
  useEffect(() => {
    ...
    const fetchMeetingData = async () => {
      try {
        const res = await fetch(`http://localhost:5000/getSingleMeeting/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5000/createAttendees/${id}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleSubmitAction = async (e) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5000/createActions/${id}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="flex gap-x-10">
        <Sidebar />
        <div className="border-2 w-full p-5 rounded-2xl mr-10 ml-10 mt-1">
                          ...
                          >
                            ...
                            <td className="pr-2">
                              <button
                                ...
                                aria-label="Close"
                                onClick={() =>
                                  deleteSingleActionEvidence(row._id)
                                }
                              >
