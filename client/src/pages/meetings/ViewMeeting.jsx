...
const ViewMeeting = () => {
  ...
  return (
    ...
    <div className="bg-cyan-100 rounded-2xl h-full overflow-y-auto">
      ...
      <div className="flex justify-end">
        ...
        (user.role === "Super Admin" ||
          ...
          <Link to={`/meeting/viewMeetings/${meeting._id}/editmeeting`}>
            <button
              type="submit"
              className="inline-flex justify-center rounded-md bg-[#52B14A] py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-[#45913e] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
            >
              Update Evidences
            </button>
          </Link>
            ...
            <tbody>
              {actions.map((action, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">{action.attendeeId.name}</td>
      ...
      <div className="flex justify-between mt-12 px-10 mb-5">
        <div>
