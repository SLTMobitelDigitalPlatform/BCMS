...
const MPROpt2 = () => {
  const rows = [
    {site: 'WTH or Nearest SLT Office', hmin: '', h: '', th: '', fh: '', sh: '', eh: '', twh: '', od: '', td: '', thd: '', fd: '', ow: '', tw: '', thw: '', fw: '', sw: '', ew: '', ew2: '', tfw: ''},
    ...
    <div className="middle-section">
      ...
      <button className="search-button">
        ...
        <div className="form-section">
          <h3 className='titleopt'>Option 2 - WFH or Nearest SLT Office</h3>
          <table>
            <thead>
              <tr>		
                <th>Site</th>
